declare module 'nedb-promises' {
  ...
  export class DataStore<D extends object = {}> extends EventEmitter {
     ...
     */
    find<T>(query: any, projection?: {[p in keyof T | '_id' | 'createdAt' | 'updatedAt']?:number}): Nedb.Cursor<T & Document<D>>
     ...
     * https://github.com/louischatriot/nedb#finding-documents
     */
    findOne<T>(query: any, projection?: {[p in keyof T | '_id' | 'createdAt' | 'updatedAt']?:number}): Promise<T & Document<D>>
     ...
     * https://github.com/louischatriot/nedb#creatingloading-a-database
     */
    static create<T extends object = {}>(pathOrOptions?: string | Nedb.DataStoreOptions): DataStore<T>
  }
